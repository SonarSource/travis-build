...
describe Travis::Build::Addons::Sonarcloud, :sexp do
  ...
  describe 'new pull request analysis' do
    ...
    it { should include_sexp [:export, ['SONARQUBE_SCANNER_PARAMS',
      "\"{ \\\"sonar.pullrequest.id\\\" : \\\"123\\\", \\\"sonar.pullrequest.base\\\" : \\\"master\\\", \\\"sonar.pullrequest.provider\\\" : \\\"GitHub\\\", \\\"sonar.pullrequest.github.repository\\\" : \\\"travis-ci/travis-ci\\\", \\\"sonar.host.url\\\" : \\\"https://sonarcloud.io\\\" }\""]] }
  end
